  ...
  <div id="main_content">
    ...
    <s:if test="hasActionErrors()">
                ...
                <s:actionmessage/>
                   ...
                   <div class="box_title"><span>Sign In</span> </div>
          <s:form action="Login" method="post" cssClass="form">
          ...
          <s:a href="register"><s:text name="New User?"></s:text></s:a>
          <s:a href="adminlogin"><s:text name="Admin?"></s:text></s:a>
        </div>
