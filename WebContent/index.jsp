...
<!--
body {
	background-image: url(images/changed-login-screen-image-osx.jpg);
}
-->
</style></head>
<body>
  ...
  <p>&nbsp;</p>
    ...
    <div class="column2">
      <div class="main_text_box">
        <h2>About Us</h2>
        <p align="justify">THE revolution of information and communication 
          technologies (ICTs) has affected education, providing 
          means to enhance both the teaching and learning processes. 
          Nowadays, technology-supported learning systems 
          (TSLSs), such as intelligent tutoring systems (ITSs), adaptive 
          hypermedia systems (AHSs), and, especially, learning 
          management systems (LMSs) such as Moodle or Blackboard are being widely used in many academic institutions 
        and becoming essential for education</p>
      </div>
      <div class="main_text_box">
        <h2>Request a proposal</h2>
        <p>To be effective, TSLSs require an appropriate Domain 
          Module, i.e., the pedagogical representation of the domain to 
          be learned. The Domain Module is considered the core of any 
          TSLSs as it represents the knowledge about a subject matter 
        to be communicated to the learner.</p>
      </div>
    </div>
    <!-- end of column two -->
    <div class="column3">
      <div class="small_title">Latest Approaches</div>
      <div class="offer_box"> <a href="#"><img src="images/dotnet1.jpg" width="150" height="114" class="img_left" border="0" /></a>
      ...
      <div class="offer_box"> <a href="#"><img src="images/j1.png" width="123" height="86" class="img_left" border="0" /></a>
    ...
    <div class="column4">
      ...
      <div class="offer_box_wide"> <a href="#"><img src="images/python-fg1.png" width="122" height="101" class="img_left" border="0" /></a>
      ...
      <div class="offer_box_wide"> <a href="#"><img src="images/dreamstimesmall_2869597.jpg" width="115" height="101" class="img_left" border="0" /></a>
      ...
      <div class="offer_box_wide"> <a href="#"><img src="images/php-fg.jpg" width="144" height="81" class="img_left" border="0" /></a>
      ...
      <div class="offer_box_wide"> <a href="#"><img src="images/other-fg.jpg" width="157" height="105" class="img_left" border="0" /></a>
